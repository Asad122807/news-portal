...
public class RejectArticleController
{
    ...
    public void initialize() {
        ...
        statusLabel.setText("Select an article, write a reason, then click Reject.");
    ...
    public void rejectButton(ActionEvent actionEvent) {
        ...
        if (reason == null || reason.trim().isEmpty()) {
            statusLabel.setVisible(true);
            statusLabel.setText("Please enter a rejection reason.");
            statusLabel.setStyle("-fx-text-fill: red;");
            return;
        }

        statusLabel.setVisible(true);
        statusLabel.setText("Article \"" + selectedArticle.getArticleTitle() + "\" rejected successfully.");
        statusLabel.setStyle("-fx-text-fill: green;");
